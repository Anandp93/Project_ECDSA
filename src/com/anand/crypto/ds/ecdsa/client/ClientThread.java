...
public class ClientThread extends Thread {
	...
	private void receiveMessage(BigInteger xHashTokens, JsonObject jsonObject) throws NoSuchAlgorithmException {
		...
		if (flag) {
			...
			System.out.println("["+client.getName()+"]: message was not signed w/ "+
	...
	private void validateMessage(BigInteger v, BigInteger r, String xString) {
		...
		if (!v.equals(r)) {
			System.out.println("["+client.getName()+"]: "
						...
						+ "message was not signed w/ "+client.getOtherPartyName()
						+"'s private key");
			flag = false;
		} 
		if (flag) {
			System.out.println("["+client.getName()+"]: "
					...
					+ "signed w/ "+client.getOtherPartyName()+"'s private key");
